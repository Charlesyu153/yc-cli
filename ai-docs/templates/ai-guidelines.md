...
**必须使用的场景**
- 新功能实现：添加有意义的新功能，需要设计实现方案
- 多种实现方案：任务可以用多种方式解决，需要选择最佳方案
- 代码重构：影响现有行为或结构的修改
- 架构决策：需要选择技术栈、设计模式或架构方案
- 多文件修改：预计会修改2-3个以上的文件
- 需求不明确：需要先探索代码库才能理解完整范围
...
**Phase 3: 文档阶段**
1. 创建任务文档：`ai-docs/current/{任务名}/{任务名}.md`
2. 将计划写入plan文件
...
2. 先澄清后计划：如有疑问先用AskUserQuestion
3. 计划要具体：提供足够的技术细节
4. 在Plan模式下创建任务文档，不要等到实现阶段
